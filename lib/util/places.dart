List places = [
  {
    "name": "Sigiriya",
    "img": "assets/sigiriya.jpeg",
    "price": r"$10/visitor",
    "location": "Dambulla, Matale",
    "details":
        "Sigiriya or Sinhagiri is an ancient rock fortress located in the northern Matale District near the town of Dambulla in the Central Province, Sri Lanka. The name refers to a site of historical and archaeological significance that is dominated by a massive column of rock around 180 metres high. According to the ancient Sri Lankan chronicle the Culavamsa, this site was selected by King Kashyapa for his new capital."
  ...
  },
  {
    ...
    "img": "assets/yala.jpeg",
    "price": r"$10/visitor",
    "location": "Yala, Colombo",
    "details":
  ...
  {
    "name": "Mermaid Hotel & Club",
    "img": "assets/mermaid.png",
    "price": r"$80/night",
    "location": "Mahawaskaduwa, Kalutura",
    "details":
        "Cosy rooms in a luxe coastal property featuring a serene spa, 4 bars & a restaurant.",
  },
  {

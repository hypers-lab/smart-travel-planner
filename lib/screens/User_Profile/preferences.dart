        ...
        child:Padding(
          ...
          child: Column(
            children: [
              ...
              SizedBox(height: 20,),
              buildPreferedItems(items: ['Jaffna','Colombo','Kilinochi','Moratuwa','Kandy','Vavuniya','Galle','Trincomalea','Batticaloa','Anuradhapura','Ratnapura','Mannar','Negombo'], title: 'Select your prefered cities '),
              SizedBox(height: 20,),
              buildPreferedItems(items: ['Monday','Tuesday','Wednesday','Thursday','Friday','Saturday','Sunday'], title: 'Select your prefered days'), 
              SizedBox(height: 10,),
              Padding(
